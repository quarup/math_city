...
class GeneratorRegistry {
  ...
  static Map<String, QuestionGenerator> _buildDefault() => {
    ...
    'mult_facts_5': multFactsN(5),
    'mult_facts_6': multFactsN(6),
    'mult_facts_7': multFactsN(7),
    'mult_facts_8': multFactsN(8),
    'mult_facts_9': multFactsN(9),
    'mult_facts_10': multFactsN(10),
