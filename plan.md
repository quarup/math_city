...
- **Phase:** Phase 6 — Full Question Bank. **163 generators implemented**; broad K–8 coverage. Remaining gaps: coordinate plane, transformations, data displays (bar/box/histogram), compound probability (needs `tree_diagram` widget).
