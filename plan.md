...
- [ ] **Build-mode UI:** catalog at the bottom listing only buildings the player has researched (rows in `BuildingTypeResearched`); tap building → tap free tile → placed; insufficient 🧱 greys out the option.
