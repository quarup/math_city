...
- **Phase:** Phase 6 — Full Question Bank. **135 generators implemented**; broad K–8 coverage. Remaining gaps: 3D geometry, coordinate plane, transformations, Pythagorean, data displays (bar/box/histogram), compound probability, `scientific_notation_ops`.
- **Last updated:** 2026-05-17
- **Last action:** **Chunk 17 — scientific notation + exponent props + repeating decimals** — 5 generators. Number theory file: `scientific_notation_read` (G8, "3.5 × 10^4" → 35000; override drops unimplemented `powers_of_10`), `scientific_notation_write` (G8, "Write 35000 in scientific notation" → "3.5 × 10^4" MC), `integer_exponent_props` (G8, three shapes: a^m·a^n, a^m÷a^n, (a^m)^n; distractor pool restructured to keep "wrong rule" candidates distinct from the correct answer across all three shapes — fixed a collision in the power-of-power case). Decimal file: `repeating_decimal_recognize` (G8, "Does N/M produce a terminating or repeating decimal?" MC), `repeating_decimal_to_fraction` (G8, curated 8 short-period cases like 0.333... → 1/3; uses "..." notation rather than the bar). Tests: +5 groups @ 300; **314 total pass**, `flutter analyze` clean.
- **Last action (prior):** **Chunk 16 — number systems + exponents** — 5 generators. Commit `425609f`.
