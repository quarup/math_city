...
- **Implementation status (auto-updated 2026-05-18):**
  - Sub-concepts: **183 / 374 implemented** (49%) — see ✅ marks in §3 tables. Source of truth: [generator_registry.dart](lib/domain/questions/generator_registry.dart).
  - Diagram widgets: **8 / 26 implemented** — see ✅ marks in §6 tables. Source of truth: [lib/presentation/diagrams/](lib/presentation/diagrams/).
...
| ✅ `BarChart(labels, values, scale)` / `Histogram` | easy–medium | `picture_graph_read`, `bar_graph_*`, `scaled_*`, `histogram`, `describe_distribution` |
