...
- **Implementation status (auto-updated 2026-05-21):**
  ...
  - Datasets: **1 / 5 integrated** — see §7.2. Source of truth: [assets/data/](assets/data/).
...
**Integrated to date:** 1 / 5. See [assets/data/](assets/data/) for the bundled JSON.
<!-- DATASET_STATUS_END -->
