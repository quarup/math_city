...
- **Implementation status (auto-updated 2026-05-17):**
  - Sub-concepts: **176 / 374 implemented** (47%) — see ✅ marks in §3 tables. Source of truth: [generator_registry.dart](lib/domain/questions/generator_registry.dart).
  - Diagram widgets: **6 / 25 implemented** — see ✅ marks in §6 tables. Source of truth: [lib/presentation/diagrams/](lib/presentation/diagrams/).
