...
- **Implementation status (auto-updated 2026-05-18):**
  - Sub-concepts: **205 / 374 implemented** (55%) — see ✅ marks in §3 tables. Source of truth: [generator_registry.dart](lib/domain/questions/generator_registry.dart).
  - Diagram widgets: **11 / 27 implemented** — see ✅ marks in §6 tables. Source of truth: [lib/presentation/diagrams/](lib/presentation/diagrams/).
