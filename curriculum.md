...
- **Implementation status (auto-updated 2026-05-19):**
  - Sub-concepts: **360 / 362 implemented** (99%) — see ✅ marks in §3 tables. Source of truth: [generator_registry.dart](lib/domain/questions/generator_registry.dart).
  - Diagram widgets: **29 / 32 implemented** — see ✅ marks in §6 tables. Source of truth: [lib/presentation/diagrams/](lib/presentation/diagrams/).
